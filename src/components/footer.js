                ...
                <div className="footer-grid">
                    ...
                    <div className="col-4">
                        ...
                        <div className="our-news-card-text">
                            ...
                            <p>
                            At Lello’s we understand that the health, safety and well-being of
                            all of our staff and customers are of the utmost importance in
                            this new world...
                            </p>
                        </div>
                        </div>
        ...
        <div className="copyright">
            <div className="container">
                <div className="copyright-flex">
                    <p className="contact-info">Lello’s  © {new Date().getFullYear()} All Rights Reserved  ~  <a href="#">Privacy Policy</a>~ <a href="#">Cookies Policy</a>  </p>
                    <a href="#" className="btn btn-bttop"><i className="fas fa-chevron-up"></i></a>
                </div>
            </div>
        </div>
    </>    
